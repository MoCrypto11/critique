    ...
    <>
      ...
      <div className="home-atmosphere" aria-hidden="true">
        ...
        >
          ...
          <g stroke="#5fe6cf" fill="none" strokeWidth="1.1">
            {animate ? (
              <animateTransform
