      ...
      <main>
        <div className="home-hero-band">
          <div className="hero-orbit-system" aria-hidden="true">
            <svg className="hero-orbits" viewBox="0 0 1440 760" preserveAspectRatio="xMidYMid slice" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g strokeLinecap="round">
                <path
                  d="M760 -40C1020 120 1160 360 1500 430"
                  stroke="#084E3E"
                  strokeOpacity="0.23"
                  strokeWidth="1.35"
                />
                <path
                  d="M860 20C1120 260 1240 520 1580 720"
                  stroke="#318B74"
                  strokeOpacity="0.17"
                  strokeWidth="1.1"
                />
                <path
                  d="M940 -80C1060 180 1180 420 1360 820"
                  stroke="#071A18"
                  strokeOpacity="0.11"
                  strokeWidth="1"
                />
                <path
                  d="M620 680C860 360 1120 280 1500 330"
                  stroke="#116149"
                  strokeOpacity="0.16"
                  strokeWidth="1.15"
                />
                ...
                />
                <path
                  d="M840 96C962 196 1098 248 1248 252"
                  stroke="#9D8146"
                  strokeOpacity="0.15"
                  strokeWidth="0.95"
                />
              ...
              <g className="hero-orbits-secondary" strokeLinecap="round">
                <path
                  d="M690 126C874 212 1034 216 1210 142"
                  stroke="#084E3E"
                  strokeOpacity="0.1"
                  strokeWidth="0.9"
                />
                <path
                  d="M812 702C946 604 1124 574 1368 618"
                  stroke="#318B74"
                  strokeOpacity="0.12"
                  strokeWidth="0.9"
                />
